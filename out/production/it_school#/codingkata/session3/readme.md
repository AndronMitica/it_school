1. Calculate the magic number from a date. The magic number is obtained by adding up the digits until a single-digit number is obtained Ex: 2002-09-11 2+0+0+2+0+9+1+1 =>15 => 1+5= 6
